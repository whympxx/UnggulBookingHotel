...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $conn->prepare('SELECT id, password FROM agents WHERE email = ? LIMIT 1');
...
<head>
    ...
    <title>Agent Login - Hotel Booking</title>
...
<body>
    <div class="login-modal">
        ...
        <?php endif; ?>
        <form method="post" action="agent_login.php">
        ...
        <div class="register-link">
            ...
            <a href="agent_register.php" class="register-btn">Register</a>
        </div>
    </div>
</body>
</html> 